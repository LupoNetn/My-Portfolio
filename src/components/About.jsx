        ...
        >
          <div className="glass-card rounded-xl p-6 sm:p-8 space-y-6">
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
              FrontEnd Developer with expertise in modern web technologies. I specialize in building efficient applications using React, Next.js, and related tools. My passion lies in creating clean, scalable solutions and staying current with emerging technologies.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              ...
              <motion.a
                href="/Daniel Lupo Resume-2025.pdf"
                download="Daniel Lupo Resume-2025.pdf"
